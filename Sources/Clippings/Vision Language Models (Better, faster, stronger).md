...
tags:
  - "clippings"
---
This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/vlms-2025).
...
[![Qwen-Omni](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/qwen-omni.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/qwen-omni.png)
...
[![kimi-vl](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/kimi-vl.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/kimi-vl.png) The model can take in long videos, PDFs, screenshots and more. It has agentic capabilities as well.
...
[![pi0](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/pi0.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/pi0.png)
...
[![PaliGemma3](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/pg2-seg.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/pg2-seg.png)
...
[![molmo](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/molmo-pointing.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/molmo-pointing.png)

Qwen2.5-VL can also detect, point to, and count objects, and this includes UI elements as objects too!

[![Qwen2.5VL](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/qwen3-gui.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/qwen3-gui.png)
...
[![Llama Guard 4](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/llama-guard.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/llama-guard.png)
...
[![Traditional Parsing](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/rag-1.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/rag-1.png)

With the rise of vision language models, this issue was addressed: there are now multimodal retrievers and rerankers.

[![Multimodal RAG](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/rag-2.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/rag-2.png)
...
[![DSE](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/dse.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/dse.png)
...
[![ColPali](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/colpali.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/colpali.png) Taken from [the paper](https://arxiv.org/pdf/2407.01449)
...
[![Video LMs](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/video.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/video.png)
...
[![MRoPE](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/mrope.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/mrope.png)  
...
[![DPO](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/dpo.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/dpo.png)
...
To train your model using *DPOTrainer*, you can optionally provide a reference model to compute the reward difference. If you’re using Parameter-Efficient Fine-Tuning (PEFT), you may omit the reference model by setting *ref\_model=None*.
...
[![MMT-Bench](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/mmt-bench.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/mmt-bench.png)
...
[May 13, 2025](#682260bbfad2293d439f47e3)

Overall, this is a really great article that gives a primer on VLMS. I just wanted to chime in and say that Florence2 is also a really good model and one of my favourites for starting with unlabeled datasets. Another shout out to Moondream2 as well, which I find runs quite fast even on CPU/MPS

·

[merve](https://huggingface.co/merve)

Article author [May 13, 2025](#68233b7326be20df2f7dd66c)

•

[edited May 13, 2025](#68233b7326be20df2f7dd66c "Edited by merve")
...
[alielfilali01](https://huggingface.co/alielfilali01)

[May 13, 2025](#6822e28f1e2b5b230c6d653b)
...
Article author [May 13, 2025](#68233b0d5f5279a4eea801da)

•

[edited May 13, 2025](#68233b0d5f5279a4eea801da "Edited by merve")

We have fixed with 4B, sorry you're correct! the snippet actually belongs to 4b and we should've linked to 4b

[alielfilali01](https://huggingface.co/alielfilali01)

[May 13, 2025](#6822e5633e15415e98fde3f2)
...
Article author [May 13, 2025](#68233a9087af8c03c4bb19e2)

I hope it was useful!

[fcakyon](https://huggingface.co/fcakyon)

[May 13, 2025](#6822f5722dcd4033dcf1fb44)
...
Article author [May 13, 2025](#68233b841de06f16901397a8)

•

[edited May 13, 2025](#68233b841de06f16901397a8 "Edited by merve")
...
[May 13, 2025](#682306a3e2358be41003d330)

I agree with Kimi-VL, I wonder can we get the GGUF version since llama.cpp supports vision as well

[1ucky1uke](https://huggingface.co/1ucky1uke)

[May 13, 2025](#68235e471d7ee98c1a41c4a0)

Thank you for the great article. There seems to be an issue in the Multimodal RAG section where the same graphic is displayed twice?  
[![grafik.png](https://cdn-uploads.huggingface.co/production/uploads/635a7dadbd6f7742b4c39d60/q06gfzNWt1mhiI1Ydhj50.png)](https://cdn-uploads.huggingface.co/production/uploads/635a7dadbd6f7742b4c39d60/q06gfzNWt1mhiI1Ydhj50.png)

·

[sergiopaniego](https://huggingface.co/sergiopaniego)

Article author [May 14, 2025](#682381294da3a6643b5083b2)

Thanks for reporting! It’s now updated 🙌

[nzarif](https://huggingface.co/nzarif)

[May 14, 2025](#6823e1205d39467d538ff6f1)
...
Article author [May 15, 2025](#6825b02df6d2e9982d8f7117)

thank you so much for your kind words! I think in general Qwen-VL variants (inc InternVL) do well yes:)

[Lallo67](https://huggingface.co/Lallo67)

[May 15, 2025](#6824e9a4b4f1e881647aa06e)
...
Article author [May 15, 2025](#6825b00de4b76596987f442d)

very happy it's of use to you, indeed I love Kimi-VL as well! super impressive with the size etc especially:)

[Jilt](https://huggingface.co/Jilt)

[May 15, 2025](#6825b8a6dc273b7a990a7e8c)

Looking forward to blog post on truly multimodal models (Omni models) in around 6 months:)

[sealical](https://huggingface.co/sealical)

[May 16, 2025](#6826a8e74bc13d8af4e4ccd8)
...
[JcZane](https://huggingface.co/JcZane)

[May 17, 2025](#68278d446b6265069d2811b5)
...
Article author [May 20, 2025](#682c8f1ba261c7cf5ecc7a3c)

Very happy it's useful for you! 💗

deleted

[May 22, 2025](#682ed92944351a3d77ee79f8)

This comment has been hidden

[jinlovespho](https://huggingface.co/jinlovespho)

[May 27, 2025](#6835771717151593d0d186dd)

wow!! thx!!:)

[bella22334](https://huggingface.co/bella22334)

[Aug 18, 2025](#68a2e2bed718d1ba4af963ea)
